...
def main():
    ...
    transform_train = transforms.Compose([Cspace(),
        transforms.RandomCrop(32, padding=4),
        transforms.RandomHorizontalFlip(),
        transforms.ToTensor(),
        transforms.Normalize((0.4914, 0.4822, 0.4465), (0.2023, 0.1994, 0.2010))])

    transform_test = transforms.Compose([Cspace(),
        transforms.ToTensor(),
        transforms.Normalize((0.4914, 0.4822, 0.4465), (0.2023, 0.1994, 0.2010))])
...
# Loading the Model    
    ...
    filename= 'Models_Softmax/CIFAR10_Softmax_Resnet20HSVColor.pth.tar'
    ...
    for epoch in range(args.max_epoch):
        ...
        if args.eval_freq > 0 and (epoch+1) % args.eval_freq == 0 or (epoch+1) == args.max_epoch:
            ...
            torch.save(state_, 'Models_PCL/CIFAR10_PCL_Resnet20HSVColor.pth.tar')
